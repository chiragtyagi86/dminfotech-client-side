    ...
    <main>
      <style>{`
        ...
        .contact-eyebrow-text {
          ...
          letter-spacing: 0.16em; text-transform: uppercase; color: var(--color-primary-2);
        }
        .contact-h1 {
          font-family: 'Cormorant Garamond', serif;
          font-size: clamp(40px, 6.5vw, 80px); font-weight: 300; line-height: 1.07;
          color: var(--color-primary); margin: 0 0 20px;
          animation: ctFadeUp 0.85s ease 0.1s both;
        }
        .contact-h1 em { font-style: italic; color: var(--color-primary-2); }
        .contact-hero-desc {
          font-family: 'DM Sans', sans-serif; font-size: 16px; font-weight: 300;
          line-height: 1.80; color: var(--color-text-soft); max-width: 500px; margin: 0;
        ...
        .contact-layout { padding: 0 0 96px; background: var(--color-bg-soft); position: relative; }
        .contact-layout::before {
          content: ''; position: absolute; top: 0; left: 0; right: 0; height: 1px;
          background: linear-gradient(90deg, transparent, rgba(104,80,68,0.10), transparent);
        }
        .contact-grid { display: grid; grid-template-columns: 1fr; gap: 40px; padding-top: 64px; }
        ...
        .contact-info-sub {
          ...
          line-height: 1.75; color: var(--color-text-soft); margin: 0 0 28px;
        }
        .contact-detail {
          display: flex; gap: 14px; align-items: flex-start; padding: 16px 18px;
          border-radius: 14px; border: 1px solid rgba(104,80,68,0.08);
        ...
        .contact-detail:hover { transform: translateX(4px); box-shadow: 0 8px 24px rgba(58,64,90,0.08); }
        .contact-detail-icon {
        ...
        .contact-detail:hover .contact-detail-icon { background: var(--color-primary); }
        .contact-detail-icon svg {
          width: 17px; height: 17px; stroke: var(--color-primary);
          stroke-width: 1.5; fill: none; transition: stroke 0.3s ease;
        }
        .contact-detail:hover .contact-detail-icon svg { stroke: var(--color-surface); }
        .contact-detail-label {
          font-family: 'DM Sans', sans-serif; font-size: 10px; font-weight: 500;
          letter-spacing: 0.14em; text-transform: uppercase; color: var(--color-text-soft); margin: 0 0 3px;
        }
        ...
        .contact-wa {
          ...
          border-radius: 14px; background: #25D366; border: none;
          text-decoration: none; cursor: pointer;
          transition: opacity 0.25s ease, transform 0.25s ease; margin-top: 4px;
        }
        .contact-wa:hover { opacity: 0.90; transform: translateX(4px); }
        .contact-wa-icon { width: 32px; height: 32px; display: flex; align-items: center; justify-content: center; }
        .contact-wa-icon svg { width: 22px; height: 22px; fill: white; }
        .contact-wa-label { font-family: 'DM Sans', sans-serif; font-size: 13.5px; font-weight: 500; color: white; }
        .contact-wa-sub { font-family: 'DM Sans', sans-serif; font-size: 11px; font-weight: 300; color: rgba(255,255,255,0.75); margin-top: 1px; }

        .contact-form-card {
          border-radius: 24px; border: 1px solid rgba(104,80,68,0.09);
          background: rgba(255,255,255,0.70); backdrop-filter: blur(14px);
          padding: 40px 36px; box-shadow: 0 8px 40px rgba(58,64,90,0.06);
        }
        .form-heading {
        ...
        .form-label {
          ...
          letter-spacing: 0.12em; text-transform: uppercase; color: var(--color-primary-2);
        }
        .form-input, .form-select, .form-textarea {
          padding: 12px 16px; border-radius: 10px; border: 1px solid rgba(104,80,68,0.14);
          background: rgba(255,255,255,0.80); font-family: 'DM Sans', sans-serif;
          font-size: 14px; font-weight: 300; color: var(--color-primary); outline: none;
          transition: border-color 0.25s ease, box-shadow 0.25s ease;
          width: 100%; box-sizing: border-box; appearance: none;
        }
        .form-input::placeholder, .form-textarea::placeholder { color: rgba(104,80,68,0.35); }
        .form-input:focus, .form-select:focus, .form-textarea:focus {
          border-color: var(--color-accent-blue); box-shadow: 0 0 0 3px rgba(153,178,221,0.15);
        }
        ...
        .form-error {
          ...
          background: #fef2f2; border: 1px solid rgba(220,38,38,0.20);
        ...
        .form-submit {
          ...
          background: var(--color-btn-primary); color: var(--color-btn-primary-text);
          font-family: 'DM Sans', sans-serif; font-size: 13px; font-weight: 500;
          letter-spacing: 0.10em; text-transform: uppercase; cursor: pointer; margin-top: 8px;
          position: relative; overflow: hidden;
        ...
        .form-submit:hover:not(:disabled) { transform: translateY(-1px); box-shadow: 0 8px 28px rgba(58,64,90,0.20); }

        .form-note {
          font-family: 'DM Sans', sans-serif; font-size: 11.5px; font-weight: 300;
          color: var(--color-text-soft); text-align: center; margin-top: 14px; line-height: 1.6;
        }
        ...
        .form-success-icon svg { width: 26px; height: 26px; stroke: white; stroke-width: 2; fill: none; }
        .form-success-title {
        ...
        .form-success-desc {
          ...
          color: var(--color-text-soft); margin: 0; max-width: 360px; line-height: 1.75;
        }
      `}</style>
      ...
      <div className="contact-page">
        ...
        <section className="contact-hero">
          <div className="contact-orb1" /><div className="contact-orb2" />
          ...
          <Container>
            <div className="contact-hero-inner">
              ...
              <h1 className="contact-h1">
                Let's build something<br /><em>worth noticing</em>
              </h1>
              ...
              <div className="contact-form-card">
                {!submitted ? (
                  <>
                    ...
                    <p className="form-subheading">Fill in the details below and we'll be in touch shortly.</p>
