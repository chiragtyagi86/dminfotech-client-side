...
const badges = [
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
        <polyline points="20,6 9,17 4,12" /><circle cx="12" cy="12" r="9" />
      </svg>
    ),
    ...
    <section className="about-trust">
      <style>{`
        ...
        @media (min-width: 768px) {
          .about-trust-stats { grid-template-columns: repeat(4, 1fr); }
        }
        ...
        @media (min-width: 640px) {
          .about-trust-badges { grid-template-columns: repeat(2, 1fr); }
        }

        @media (min-width: 1024px) {
          .about-trust-badges { grid-template-columns: repeat(3, 1fr); }
        }
