// app/admin/pages/contact/page.tsx
// ─────────────────────────────────────────────────────────────────────────────
...
export default function ContactPageEditor() {
  ...
  async function handleSave() {
    setSaving(true);
    // CMS NOTE: POST /api/admin/pages/contact with content
  ...
  return (
    <div className="cpe-root">
      <style>{`
        ...
        .cpe-tab.active { color: var(--color-primary, #3a405a); border-bottom-color: var(--color-primary, #3a405a); font-weight: 500; }
      ...
      <div className="cpe-topbar">
        <Link href="/admin/pages" className="cpe-back">← Back</Link>
