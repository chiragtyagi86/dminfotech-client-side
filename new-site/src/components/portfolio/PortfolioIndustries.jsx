// src/components/portfolio/PortfolioIndustries.jsx
...
const STATIC_CASE_STUDY = {
  title: "Corporate Website Redesign",
  industry: "Professional Services",
  problem:
    "The client had an outdated website that failed to communicate authority, generated no organic traffic and had no mobile experience. Potential clients were dropping off within seconds.",
  solution:
    "We redesigned the entire digital presence — new information architecture, mobile-first UI, SEO-structured content, CMS integration and performance optimisation — in a focused 6-week engagement.",
  results: [
...
export default function PortfolioIndustries({ caseStudy }) {
  const cs =
    caseStudy && (caseStudy.problem || caseStudy.solution)
      ? caseStudy
      : STATIC_CASE_STUDY;
    ...
    <>
      <section className="port-ind-section">
        <style>{`
          ...
          .port-ind-card:hover .port-ind-icon svg {
          ...
          <div className="port-cs-card">
            ...
            <div className="port-cs-inner">
              <div>
                ...
                <h3 className="port-cs-client">{cs.title || cs.clientName}</h3>
