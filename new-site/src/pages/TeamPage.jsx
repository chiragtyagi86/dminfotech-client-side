          ...
          <Container>
            <div className="team-hero-inner">
              ...
              <p className="team-sub">
                A passionate group of designers, engineers and strategists united by a
                love of craft and a commitment to delivering real results.
              </p>
              {error && (
                <p className="team-note">
                  Live team data could not be loaded, so fallback team members are being shown.
                </p>
              )}
            </div>
          </Container>
                  ...
                  <div className="team-card-photo">
                    {m.avatar ? (
                      ...
                      <>
                        ...
                        <div className="team-card-photo-initials">{getInitial(m.name)}</div>
                      </>
                    )}
                  </div>
