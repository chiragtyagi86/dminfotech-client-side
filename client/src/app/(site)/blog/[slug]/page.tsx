          ...
          <div className="art-cover">
            {post.cover_image ? (
              <img
                ...
                alt={post.title}
                style={{ width: "100%", maxHeight: "440px", objectFit: "cover", borderRadius: "20px" }}
              />
            ) : (
              <div className="art-cover-placeholder">
                <div
                  className="art-cover-bg"
                  style={{ background: `linear-gradient(145deg, ${post.coverAccent}, rgba(255,250,247,0.50))` }}
                />
                <div className="art-cover-grid" />
                <span className="art-cover-label">{post.category_icon} {post.category}</span>
              </div>
            )}
          </div>
        </Container>
            ...
            <article className="art-prose">
              ...
              <div className="art-links-block">
                ...
                {[
                  ...
                  <Link key={link.href} href={link.href} className="art-link-row">
              ...
              <div className="art-cta">
                <div className="art-cta-inner">
                  ...
                  <h3 className="art-cta-title">
                    Need a modern website or<br /><em>custom software solution?</em>
                  </h3>
                  <div className="art-cta-btns">
                    <Link href="/contact" className="art-cta-btn-primary">Book Free Consultation →</Link>
                    <Link href="/services" className="art-cta-btn-secondary">View Services</Link>
                  </div>
                </div>
              </div>
        ...
        <section className="art-related-section">
          <Container>
            ...
            <div className="art-related-grid">
              {related.map((rel) => (
                <Link key={rel.slug} href={`/blog/${rel.slug}`} className="art-rel-card">
                  ...
                  <div className="art-rel-body">
                    <p className="art-rel-cat">{rel.category_icon} {rel.category}</p>
                    <h3 className="art-rel-title">{rel.title}</h3>
                    <p className="art-rel-excerpt">{rel.excerpt?.slice(0, 100)}…</p>
