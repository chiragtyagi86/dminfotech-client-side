  ...
  return (
    <section className="svc-hero">
      <style>{`
        ...
        .svc-hero-card:nth-child(2) { margin-top: 20px; }
        .svc-hero-card:nth-child(4) { margin-top: -20px; }
        ...
        <div className="svc-hero-inner">
          ...
          <div>
            ...
            <div className="svc-hero-pills">
              {["Website Development", "Software Solutions", "IT Placements", "Journal Publishing", "Stock Market Training", "SEO & UI/UX"].map((p) => (
          ...
          <div className="svc-hero-cards">
            {[
              { title: "Web & Software", label: "Business websites, apps & automation", icon: <><rect x="3" y="3" width="18" height="18" rx="3"/><polyline points="9,9 15,9"/><polyline points="9,13 13,13"/></> },
              { title: "IT Placements", label: "Talent sourcing & tech staffing", icon: <><circle cx="12" cy="8" r="3"/><path d="M6 20v-2a6 6 0 0112 0v2"/></> },
              { title: "Research Journals", label: "Academic & professional publishing", icon: <><path d="M4 4h16v14H4z"/><line x1="8" y1="9" x2="16" y2="9"/><line x1="8" y1="13" x2="13" y2="13"/></> },
              { title: "Stock Training", label: "Market analysis & investment learning", icon: <><polyline points="3,17 8,12 12,14 17,7 21,9"/><line x1="3" y1="20" x2="21" y2="20"/></> },
            ].map((card) => (
