// app/admin/testimonials/components/TestimonialsList.tsx
// ─────────────────────────────────────────────────────────────────────────────
// Testimonials list component with search, edit, delete actions
// ─────────────────────────────────────────────────────────────────────────────
    ...
    <div className="testimonials-list">
      <style>{`
        ...
        .card-btn-featured:hover {
          background: rgba(34, 134, 58, 0.25);
        }

        .card-btn-featured.active {
          background: #22863a;
          color: white;
        }
                ...
                <div className="card-rating">
                  {[...Array(5)].map((_, i) => (
                    <span
                      ...
                      className="card-star"
                      style={{
                        opacity: i < (testimonial.rating || 0) ? 1 : 0.2,
                      }}
                    >
                      ★
                    </span>
