// app/admin/testimonials/components/TestimonialForm.tsx
// ─────────────────────────────────────────────────────────────────────────────
// Reusable form component for creating and editing testimonials
// ─────────────────────────────────────────────────────────────────────────────
    ...
    <form onSubmit={handleSubmit} className="testimonial-form">
      <style>{`
        ...
        .form-checkbox {
          ...
          height: 18px;
          cursor: pointer;
          accent-color: var(--color-primary, #3a405a);
        }
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            <div className="rating-group">
              ...
              <span style={{ fontFamily: "DM Sans", fontSize: "13px", color: "rgba(104,80,68,0.55)" }}>
                {formData.rating} / 5
              </span>
            </div>
          </div>
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) =>
                setFormData({ ...formData, shortHighlight: e.target.value })
              }
            />
          </div>
        </div>
