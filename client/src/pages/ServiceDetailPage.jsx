...
function stripQuillDarkStyles(html = "") {
  return html
...
export default function ServiceDetailPage() {
  ...
  const {
    ...
    loading,
    error,
  } = useApi(() => api.getService(slug), [slug]);
  ...
  const highlights = Array.isArray(content.highlights)
    ? content.highlights.filter((h) => h && (h.label || h.detail))
    : [];
  ...
  return (
    <>
    <Seo
      title={`${service.title} | Services — Dhanamitra Infotech LLP`}
          ...
          <Container>
            <div className="svc-hero-inner">
              ...
              <div className="svc-hero-btns">
                <Link to="/contact" className="svc-btn-primary">
                  Get a Free Consultation →
                </Link>
                <Link to="/services" className="svc-btn-secondary">
                  All Services
                </Link>
              </div>
            </div>
            ...
            <div className="svc-body-grid">
              ...
              <aside className="svc-sidebar">
                <div className="svc-sidebar-card">
                  ...
                  <Link to="/contact" className="svc-sidebar-btn">
