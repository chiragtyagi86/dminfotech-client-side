    ...
    <section className="port-hero">
      <style>{`
        ...
        .port-orn-diamond {
          width: 5px;
          height: 5px;
          border: 1px solid rgba(104,80,68,0.28);
      ...
      <div className="port-hero-orb1" />
      <div className="port-hero-orb2" />
      <div className="port-hero-grid" />

      <Container>
        <div className="port-hero-inner">
          <div className="port-eyebrow-wrap">
          ...
          <h1 className="port-h1">
            Digital solutions <em>delivered</em>
          </h1>
          ...
          <div className="port-filters">
            {[
              ...
              <span
                key={f}
                className={`port-filter-pill${f === "All Work" ? " active" : ""}`}
              >
                {f}
              </span>
            ))}
